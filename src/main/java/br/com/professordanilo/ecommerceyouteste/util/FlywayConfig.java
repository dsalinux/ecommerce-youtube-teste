...
public class FlywayConfig implements ServletContextListener {
    ...
    public void configure() {
        try {
            ...
            Flyway flyway = Flyway.configure().dataSource((DataSource) ctx.lookup("java:comp/env/jdbc/TestyoutubeDB")).load();
            flyway.migrate();
    ...
    public void contextInitialized(ServletContextEvent sce) {
        Logger.getLogger(FlywayConfig.class.getName()).log(Level.INFO, "Executando flyway.");
        configure();
    }
